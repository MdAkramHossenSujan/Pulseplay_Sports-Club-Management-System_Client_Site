...
const NavbarHome = () => {
    ...
    return (
        <header  className={`fixed top-0 left-0 w-full   z-50 transition-colors duration-500 ease-in-out ${
            scrolledHalf ? "dark:bg-base-200 bg-base-100 shadow border-b border-gray-400 dark:border-green-900" : "bg-transparent"
          }`}>
