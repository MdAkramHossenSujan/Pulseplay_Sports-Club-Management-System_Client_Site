  ...
  return (
    <div className='max-w-[1400px] mx-auto'>
      ...
      >
        {/* Image 1 */}
        <motion.div
          className="w-72 relative h-72 rounded-full overflow-hidden shadow-lg ring-4 ring-gray-300 dark:ring-green-900"
        ...
        {/* Image 2 */}
        <motion.div
          className="w-72 relative h-72 rounded-full overflow-hidden shadow-lg ring-4 ring-gray-300 dark:ring-green-900 lg:-mt-24"
          whileHover={{ scale: 1.05 }}
        >
          <img
            src={two}
